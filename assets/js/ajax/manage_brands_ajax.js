        ...
        $.ajax({
            ...
            success: function(data){                
                ...
                {           
                    ...
                    var brand_name;    
                    if(details[i].brand_name!=null){ var brand_name=details[i].brand_name; }else{ var brand_name=""; }
                    if(details[i].brand_slug!=null){ var brand_slug=details[i].brand_slug; }else{ var brand_slug=""; }
                    if(details[i].brand_image!=null){ var brand_image=details[i].brand_image; }else{ var brand_image=""; }
