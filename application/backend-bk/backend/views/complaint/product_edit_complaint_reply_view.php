...
<div class="app-content  my-3 my-md-5">
                    <div class="side-app">
                        <div class="page-header">
                            <h4 class="page-title">Product complaint Reply</h4>
                            <ol class="breadcrumb">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card m-b-20">
                                    ...
                                    <div class="card-body mb-0">
                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin_complaint/edit_product_complaint_reply_submit" role="form" method="post" enctype="multipart/form-data">
                                           ...
                                           <div class="form-group ">                                                
                                             ...
                                             <div class="form-group ">                                                
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label" id="examplenameInputname2"> complaint Title </label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <?php echo $row->product_complaint_title; ?>
                                                    </div>
                                                </div>
                                            </div>
