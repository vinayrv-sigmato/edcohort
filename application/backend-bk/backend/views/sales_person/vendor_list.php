 ...
 <section class="content">
    <div class="container-fluid">
        <div class="row row-header">
            <div class="col-md-8">
            <h2>Sales Person <small>Sales Person List</small></h2>
            </div>
            <div class="col-md-4">
              <div class="">
                <a href="<?php echo base_url(); ?>admin_sales_person/add_sales_person" class="btn btn-sm btn-primary btn-flat pull-left"><i class="fa fa-plus"></i> Add Sales Person</a>
              </div>
             <!--  <div class="">
    ...
    <?php message(); ?>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="header">
                        <span class="header_span">Sales Person List (Total: <total id="total_records"></total>)</span>                        
                            ...
                            <table id="example" class="table table-bordered table-responsive table-striped table-hover table-condensed js-basic-example1 dataTable">
                              ...
                              <?php foreach ($vendor_list as $vendor): ?>
                                <tr role="row" class="text-bold" >
                                  ...
                                  <!-- <td class=""><?php echo $vendor->markup; ?></td> -->
                                  <td class="">
                                    <a href="<?php echo base_url(); ?>admin_sales_person/edit_sales_person/<?php echo $vendor->CD_USER_ID; ?>" class="btn btn-primary btn-sm btn-flat upper"><i class="fa fa-pencil"></i> Edit</a>
...
<script type="text/javascript">
 ...
 <script>
    function vendor_details(id) {
      ...
      var last_activity="";
      $.ajax({
        url: base_url+'admin_sales_person/vendor_details_ajax',
        dataType: 'json',
        type: 'post',            
        data: {'vendor_id': id,},                                         
