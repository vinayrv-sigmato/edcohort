                ...
                <form id="form">
                        ...
                        <div class="col-sm-10 col-md-9 col-lg-10 col-12">
                          ...
                          <ul class="certified-icon">
                            ...
                            <li data-shape="round" data-shape-delta="0">
                              ...
                              <input type="checkbox" name="cert[]" onchange="submitForm()" value="HRD">

                              <img src="<?php echo base_url(); ?>assets/img/hrd.png"> </li>  
                          </ul>
                    ...
                    <div class="col-sm-10 col-md-9 col-lg-10 col-12">
                        <div class="form-group">
                            <div class="form-line">
                                <select class="form-control" name="filter_status" id="filter_status" onchange="submitForm()">
                      ...
                      <div class="col-sm-6 col-md-4 col-lg-4 col-12">
                       ...
                       <div class="col-sm-6 col-md-4 col-lg-4 col-12">
                        ...
                        <div class="col-sm-10 col-md-9 col-lg-10 col-12">
                          <input type="text" class="form-control text-design" name="certificate" value="" onblur="submitForm()" placeholder="EX: 121,122,123" style="margin-top: 10px;">            
                        </div>
                      </div>   
                             <?php if($user_id==1){ ?>
                          <div class="col-sm-6 col-md-4 col-lg-4 col-12">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                               <select class="form-control" name="filter_vendor" id="filter_vendor">
                                    ...
                                    <option value="<?php echo $vendor->NM_USER_FULLNAME; ?>" <?php if($filter_category==$category->category_name){ echo "selected";} ?>><?php echo $category->category_name; ?></option>
                                 <?php endforeach ?>
                                </select>                          
                            </div>                                           
                        </div>
...
<!--                                 <th class="header1">Availability</th> 
 -->
                                ...
                                <th class="header1" style="">Status</th>
...
///////////////////////////////////////////////////////////
    ...
    var from_symmetry_val = 'EX';

    var to_symmetry_val = 'FR'; 
    ...
    var $range_52ac = $("#range_52ac"),
        ...
        var from_fluorescence_val = 'NON';

        var to_fluorescence_val = 'VST'; 
