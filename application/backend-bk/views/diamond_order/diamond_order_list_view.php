 ...
 <section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row row-header">
            ...
            <h2>Diamond Order <small>Diamond Order List</small></h2>
            ...
            <div class="body ">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-line">
                                ...
                                <input name="filter_stock_id" id="filter_stock_id" value="<?php echo  $filter_stock_id; ?>" class="form-control">                                                            
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-line">
                                ...
                                <input name="filter_vendor" id="filter_vendor" value="<?php echo  $filter_vendor; ?>"  class="form-control">                              
                ...
                <div class="row clearfix col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">                        
                        ...
                        <a href="<?php echo base_url() ?>admin_diamond_order" class="btn bg-red btn-block waves-effect" ><i class="material-icons">refresh</i><span>RESET</span></a>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="header">
                        ...
                        <span class="header_span">Diamond Order List</span>
...
<script src="<?php echo base_url(); ?>assets/ajax/manage_diamond_order_ajax.js"></script>
