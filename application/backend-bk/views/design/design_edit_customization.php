  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/front/css/easyzoom.css" />
     <link rel="stylesheet" media="all" href="<?php echo base_url(); ?>assets/admin/custom/css/style.css">
<style>
    .column.text-left {
    position: absolute;
    bottom: 0px;
...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/custom/css/style_product.css">
        ...
        <div class="product">
                  ...
                  <div style="width:100%;text-align: center;" >
                    <?php for ($a = 0;$a < 1;$a++)
                      ...
                      <?php if (($records['0']->product_id == 0) || ($records['0']->product_id == ''))
                        { ?> 
                           <div class="easyzoom easyzoom--with-thumbnails" style="display: block !important;" id="easy_zoom"> <a href="<?php echo base_url() . 'uploads/design/' . $image_array['0']->image; ?>"> <img src="<?php echo base_url() . 'uploads/design/' . $image_array['0']->image; ?>" alt="" width="90%" height="50%" /> </a> </div>
                        <?php } else { ?> 
                      ...
                      <ul class="thumbnails">
                        ...
                        <?php foreach ($image_array as $k => $value)
                          {  ?>
                            ...
                            <?php if (($records['0']->product_id == 0) || ($records['0']->product_id == ''))
                              { ?> 
                                  <li> <a href="<?php echo base_url() . 'uploads/design/' . $value->image; ?>" data-standard="<?php echo base_url() . 'uploads/design/' . $value->image; ?>"> <img onclick="showZoom()"  src="<?php echo base_url() . 'uploads/design/' . $value->image; ?>" alt="" /> </a> </li>
                            <?php  } else { ?>
          ...
          <?php if($records['0']->design_id != null){ $design_id=$records['0']->design_id; }else{ $design_id=""; }  ?>    
           ...
           <div class="entry">
                      ...
                      <td>
                        ...
                        $processimg = $this->common_model->selectWhere('tbl_process_image',$where2); ?>
                         ...
                         <?php foreach ($processimg as $img) { ?>
                           <a href="<?php echo base_url(); ?>uploads/design/<?php echo $img->image; ?>" target="_blank" ><img src="<?php echo base_url(); ?>uploads/design/<?php echo $img->image; ?>" width="100px" > </a>
                       <?php  } ?>
                      </td>
            ...
            <form action="<?php echo base_admin(); ?>design_customization/design_edit_submit" method="post" enctype="multipart/form-data">
          ...
          <?php } ?>
           <?php if($records['0']->is_approved == 1){ ?>
            <form action="<?php echo base_admin(); ?>design_customization/design_process_submit" method="post" enctype="multipart/form-data">
...
<link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/custom/css/manage_product.css">
<script src="<?php echo base_url() ?>assets/admin/custom/js/manage_product.js"></script> 
<script src="<?php echo base_url() ?>assets/admin/custom/js/manage_diamond_ajax.js"></script>
...
<script src="<?php echo base_url(); ?>assets/front/js/easyzoom.js"></script>
<script>
