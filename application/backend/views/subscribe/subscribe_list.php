<div class="app-content  my-3 my-md-5">
                    <div class="side-app">
                        <div class="page-header">
                            ...
                            <h1>
                                <a href="<?= site_url('admin_subscribe') ?>" class="btn btn-info">Refresh</a>
                            </h1>
                            </section>
                            </ol>
                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($records as $rec) { ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url(); ?>admin_subscribe/delete_subscriber/<?php echo $rec->id; ?>" onclick="return confirm('Are you sure?')" class="btn btn-outline-light btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-original-title="Delete"><i class="fe fe-trash fs-16"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php $cnt++; } ?>
