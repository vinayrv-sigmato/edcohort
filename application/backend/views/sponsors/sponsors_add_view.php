                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card m-b-20">
                                    ...
                                    <div class="card-body mb-0">
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin_sponsors/add_sponsors_submit" method="post" enctype="multipart/form-data">
                                            <div class="form-group ">                                                
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="sponsors_name" name="sponsors_name" placeholder="Enter Name" required onkeyup="category_slug_name(this.value)">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="sponsors_slug" id="sponsors_slug" placeholder="Slug" required>
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea id="editor1" class="form-control no-resize" name="sponsors_description" rows="3" cols="80" placeholder="sponsors Description"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
