                                    ...
                                    <div class="card-body mb-0">
                                        <form class="form-horizontal" action="<?php echo base_url()?>admin_category/add_category_submit" id="main" method="post" enctype="multipart/form-data">
                                           ...
                                           <!--  <div class="form-group ">                                                
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label" id="examplenameInputname2">Parent Category <span style="color:red">*</span></label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select class="form-control" name="parent_category" id="parent_category" onchange="get_subcategory(this.value)" required>
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="category_slug" id="category_slug" placeholder="Category Slug" required>
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label" id="inputPassword5">Category Banner <span style="color:red">*</span></label>
                                                    </div>
                                                    <div class="col-md-9">
