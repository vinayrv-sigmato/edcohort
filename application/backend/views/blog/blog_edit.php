                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                      <input type="hidden" name="hid_image" value="<?php echo @$blog_details['0']->blog_image; ?>">
                                                        ...
                                                        if(@$blog_details['0']->blog_image!=""){
                                                            $preview_image = $newUrl.'/uploads/blog/'.$blog_details['0']->blog_image;
                                                            ?>
                                                          <img id="upload_pic" width="100" height="100" class="img-thumbnail" src="<?php echo base_url(); ?>../uploads/blog/<?php echo @$blog_details['0']->blog_image; ?>" alt="no-image" onclick="showImagePreview()">
                                                        <?php } else{ 
