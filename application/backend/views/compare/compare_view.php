<div class="app-content  my-3 my-md-5">
                    <div class="side-app">
                        <div class="page-header">
                            <h4 class="page-title">Manage Compare </h4>
                            <ol class="breadcrumb">
                            <section class="content-header">
                            <h1>
                                <a href="<?= site_url('admin_compare/add_compare') ?>" class="btn btn-info">Add New</a>
                            </h1>
                            </section>
                            </ol>
                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Compare List</h3> 
                                            ...
                                            <table class="data-table-example table table-striped table-bordered table-hover text-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($records as $rec) { 
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url(); ?>admin_compare/edit_compare/<?php echo $rec->id; ?>" class="btn btn-outline-light btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-original-title="Edit"><i class="fe fe-edit-2 fs-16"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php $cnt++; } ?>
                                                </tbody>
