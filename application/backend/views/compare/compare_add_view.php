                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin_segment/add_segment_submit" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">                                                
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="segment_name" name="segment_name" placeholder="Enter Complaint Score" required onkeyup="category_slug_name(this.value)" required>
                                                    </div>
                                                </div>
                                            </div>
