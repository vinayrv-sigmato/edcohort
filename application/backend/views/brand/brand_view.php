<div class="app-content  my-3 my-md-5">
                    <div class="side-app">
                        <div class="page-header">
                            ...
                            <h1>
                                <a href="<?= site_url('admin_brand/add_brand') ?>" class="btn btn-info">Add New</a>
                            </h1>
                            </section>
                            </ol>
                        </div>
                                            ...
                                            <table class="data-table-example table table-striped table-bordered table-hover text-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($records as $rec) { ?>
                                                        ...
                                                        <td><img src="<?php echo base_url(); ?>../uploads/brand/<?php echo $rec->brand_image; ?>" width="120"></td>
                                                        <td><?php echo $rec->brand_description; ?></td>
                                                        <td><?php if($rec->brand_status == 1){ ?>
