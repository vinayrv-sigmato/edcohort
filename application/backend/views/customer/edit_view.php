                                    ...
                                    <div class="card-body mb-0">
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin_customer/edit_customer_submit" method="post">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label" id="inputEmail3">Email <span style="color:red">*</span></label>
                                                    </div>
                                                    <div class="col-md-9">
                                             ...
                                             <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label" id="inputPassword5">Phone <span style="color:red">*</span></label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="phone" name="phone" value="<?php echo@$customer_detail['0']->phone; ?>" required  placeholder="Phone" maxlength="10">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label" id="inputPassword5">Password <span style="color:red">*</span></label>
                                                    </div>
                                                    <div class="col-md-9">
