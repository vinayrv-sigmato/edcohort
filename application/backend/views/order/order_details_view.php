...
<section class="content">
    <div class="container-fluid">
        ...
        <?php message(); //echo "<pre>";print_r($order_details); ?>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row clearfix text-right" style="padding-right:25px;">
                            <?php if($order->payment_method == 'Wire Bank'){?>
                            <a href="<?php echo base_url().'admin_order/wire_email/'.$order->order_id; ?>" class="btn btn-primary">Send Bank Details</a>
                            <?php }?>
                        </div>
                         <div class="row clearfix">
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-12 ">                          
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <p><strong>Product: </strong><?php echo $order->order_product_name; ?></p>
                                        <?php echo $order->cart_attributes; ?>
                                        <?php if (count($order->diamond_attach)): ?>
                                            <p><strong>With </strong><?php echo $order->diamond_attach['0']->order_product_name; ?></p>
                                        <?php endif ?>                                         

                                        <p><strong>Product SKU#: </strong><?php echo $order->stock_id; ?></p>
                            ...
                            <div class="order-price-list col-lg-4 col-md-4 col-sm-4 col-12">  
                                ...
                                <ul class="">
                                    ...
                                    <li class=""><strong>Price:</strong> <span class="pull-right">$ <?php echo number_format(round($order->total)); ?></span></li>
                                    ...
                                    <li class=""><strong>Total:</strong> <span class="pull-right">$ <?php echo number_format(round($order->order_shipping_cost+$order->total)); ?></span></li>
                                </ul>                              
                            </div>
                        </div>
                    </div>
