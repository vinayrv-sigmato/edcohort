...
class Comparison_model extends CI_Model {
  function comparison_list_limit($where,$limit='',$offset=0,$order='')
  {  
      if($where!=""){        
        $where="WHERE ".$where;
      }      
  ...
  function comparison_list($where)
  { 
      if($where!=""){        
        $where="WHERE ".$where;
      }      
  ...
  function comparison_comparison($where)
  { 
      if($where!="")
      {
        $where="WHERE ".$where;
  ...
  function comparison_attribute($where)
  { 
      if($where!=""){
        $where="WHERE ".$where;
      }
  ...
  function comparison_count($where)
  {
      if($where!=""){        
        $where="WHERE ".$where;
      }
  ...
  function getProductcomparisonLimit($where,$limit='',$offset=0)
  {
      if($where!=""){        
        $where="WHERE ".$where;
      }
      $query=$this->db->query("SELECT pr.*,c.firstname,c.lastname,p.product_name,p.product_slug FROM tbl_product_comparison as pr 
        join tbl_product as p ON pr.product_id=p.product_id 
        join tbl_customer as c ON pr.user_id=c.customer_id  ".$where." order by product_comparison_id desc limit ".$offset." , ".$limit);
      return $query->result();  
  }
  function getProductcomparison($where)
  {
      if($where!=""){        
        $where="WHERE ".$where;
      }
  ...
  function getProductcomparisonCount($where)
  {
      if($where!=""){        
        $where="WHERE ".$where;
      }
      $query=$this->db->query("SELECT count(product_id) as comparison_count FROM tbl_product_comparison as pr ".$where."");
      return $query->result();  
  }
  function getProductcomparisonSum($where)
  {
      if($where!=""){        
        $where="WHERE ".$where;
      }
      $query=$this->db->query("SELECT SUM(product_rating) as comparison_sum FROM tbl_product_comparison as pr ".$where."");
      return $query->result();  
  }
function getcomparison($where)
 {
    $this->db->select('*');
    $this->db->from('tbl_product_comparison as PR');
   ...
   // echo $this->db->last_query(); die;
    ...
    $this->db->from('tbl_product_comparison');
    $query = $this->db->get();
	return $query->result();
	}
	...
	function rating_total($id,$star = NULL)
  {
      ...
      $query = $this->db->query("SELECT SUM(product_rating) as total FROM tbl_product_comparison where ".$where."");     
      return $query->result();
  } 
  
   function comparison_search_count($where)
  {
      if($where!=""){        
        $where="WHERE product_id = ".$where;
      }
      $select='count(product_id) as comparison_count';
      //$table_name='tbl_product as P';   
      $query = $this->db->query("select ".$select." from tbl_product_comparison_search ".$where."  ");
      return $query->result();
  }
