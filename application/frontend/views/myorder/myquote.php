<div class="breadcrumb ">  
   <div class="container">
    ...
    <div> <h2><span>My Quote </span></h2></div>
     <div><ul class="nav">
      <li class="nav-item">
                ...
                <div class="row border-top">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2 pull-right">
                            ...
                            <a href="<?php echo base_url(); ?>design"><button type="button" class="btn btn-flat btn-primary"><i class="fa fa-refresh"></i> Reset</button></a>
                        </div>
                    </div>                
                </div>
                  ...
                  <div class="col-sm-12 ">
                    <div class="table-responsive">          
                      <table id="example" class="tablesorter table display nowrap table-bordered table-condensed"> 
                          ...
                          <tr> 
                              <!-- <th style="" class="remove-icon">Image</th> --> 
                             ...
                             <!--  <th class="header" style="">Center diamond</th> -->
                              ...
                              <!-- <th class="header" style="">Approved Date</th>  --> 
                      ...
                      <?php if(!empty($records)){
                       ...
                       <!--  <td><img src="<?php base_url(); ?>uploads/design/<?php echo $rec->image; ?>" style="width: 100px" ></td> -->  
                        ...
                        <!-- <td><?php echo $rec->approved_date; ?></td>   -->
