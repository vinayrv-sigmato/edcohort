...
<div class="inner-banner">
   ...
   <div class="tab-menu">
      <ul>
         <li class="active"><a href="<?php echo base_url(); ?>complaint?course=<?php echo @$course; ?>&segment=<?php echo $segment; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Complaint <?php echo $complaint_count; ?></a></li>
         <li><a href="<?php echo base_url(); ?>comparison?course=<?php echo @$course; ?>&segment=<?php echo $segment; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Compare </a></li>
         <li><a href="<?php echo base_url(); ?>counselling?course=<?php echo @$course; ?>&segment=<?php echo $segment; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Counselling </a></li>
         <li><a href="<?php echo base_url(); ?>cohort?course=<?php echo @$course; ?>&segment=<?php echo $segment; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Cohort</a></li>
         <li><a href="<?php echo base_url(); ?>review?course=<?php echo @$course; ?>&segment=<?php echo $segment; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Reviews </a></li>
         <li><a href="<?php echo base_url(); ?>coupon?course=<?php echo @$course; ?>&segment=<?php echo $segment; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Coupons</a></li>
      </ul>
   </div>
</div>
<!--banner end-->
...
<div class="container-fluid review-top-section">
    ...
    <div class="row">
        ...
        <a href="<?php echo base_url();?>write-a-complaint?course=<?php echo @$course; ?>&segment=<?php echo $segment;?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>" class="review-btns">
                <i class="fa-solid fa-circle-user fa-2xl design-user"></i> <span> Write a Complaint </span> <label for="rating2"><img src="<?php echo base_url();?>assets/images/rating-1.png"
                              alt=""> </label>
         </a>
         <?php } else{ ?>
            <a href="javascript:void(0)" class="review-btn" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button"><img src="<?php echo base_url();?>assets/images/review-icon2.png" alt="" >Write a Complaint</a>
            <?php } ?>
   ...
   <div class="col-md-2 review-left">
      ...
      <div class="review-center">
         <div class="review-btn-box">
            <?php /*if($this->session->userdata('user_id')){ ?>
               <a href="<?php echo base_url();?>write-a-complaint?course=<?php echo @$course; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>" class="review-btn"><img src="<?php echo base_url();?>assets/images/review-icon2.png" alt=""> Write a Complaint</a>
            <?php } else{ ?>
               <a href="javascript:void(0)" class="review-btn" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button"><img src="<?php echo base_url();?>assets/images/review-icon2.png" alt="" >Write a Complaint</a>
            <?php } */?>
         </div>
         <div class="review-inner-center">
            <div class="tab-link">
               <ul>
                  ...
                  <?php if($this->session->userdata('user_id')){ ?>
                     <li>
                        <a href="<?php echo base_url(); ?>my-complaint?course=<?php echo $course; ?>">My Complaint</a>
                     </li>
                  <?php } else{ ?>
                     <li>
                       <a href="javascript:void(0)" class="review-btn" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button">My Complaint</a>
           ...
           <div class="total-review">
            <!-- 9 of --><?php echo $complaint_count;?> Complain<?php if($complaint_count > 1){ echo "s"; } ?> 
         </div>
         ...
         <div class="review-box">
            <?php if($complaint_list){ ?>
               <?php foreach($complaint_list as $complain){?>
                  ...
                  <div class="review-row">
                     ...
                     <div class="review-title-row d-flex flex-wrap justify-content-between align-items-center">
                        <h2 class="review-title">
                           <?php echo ucwords($complain->user_name); ?> <span><img src="<?php  base_url() ?>assets/images/verifyicon.png" alt=""></span>
                      ...
                      <?php   $current = strtotime(date("Y-m-d"));
                       ...
                       <div class="d-flex">
                        ...
                        <?php } ?>
                        <div class="review-date <?php echo $today ?>"> <?php if(!empty($today)){ echo "Today"; }else{ echo date('d F Y',strtotime($complain->product_complaint_added));  }?> </div>
                     </div>
                  </div>
                  ...
                  <div>
                     <h2 class="review-cmt-title"><?php echo $complain->product_complaint_title;?></h2>
                  </div>
                  <div class="review-content" id="complaintShort_<?php echo $complain->product_complaint_id;?>">
                     <?php echo substr($complain->product_complaint,0,185); ?>
                  </div>
                  <?php  $words = substr_count($complain->product_complaint, " ");
                  if($words > 30){ ?>
                    <div class="review-read" id="complaint-read_<?php echo $complain->product_complaint_id;?>"><a href="javascript:void(0)" id="complaintShortRM_<?php echo $complain->product_complaint_id;?>" onclick="productComplaintReadMore('<?php echo $complain->product_complaint_id;?>')">(Read more)</a></div>
                 <?php } ?>
                 <div class="review-content" style="display:none" id="complaintFull_<?php echo $complain->product_complaint_id;?>"> <?php echo $complain->product_complaint; ?>
                 <div class="review-read">
                  <a href="javascript:void(0)" id="complaintShortRS_<?php echo $complain->product_complaint_id;?>" onclick="productComplaintReadShort('<?php echo $complain->product_complaint_id;?>')">(Read Short)</a>
               </div>
            </div>
            <div class="review-footer d-flex flex-wrap justify-content-between align-items-center">
               ...
               <?php if(sizeof($complaint_reply) == 0){ ?>
                  <div class="review-footer-left"><?php echo sizeof($complaint_reply); ?> Replies</div>
               <?php } else{ ?>
                  <div class="review-footer-left"><?php echo sizeof($complaint_reply); ?> Replies <a href="javascript:void(0)" onclick="viewRepliesAll('<?php echo $complain->product_complaint_id; ?>')">View all replies</a></div>
               <?php } ?>
               <div class="review-footer-right d-flex">
                 ...
                 <?php if($this->session->userdata('user_id')){ ?>
                  <?php if($likeCount > 0 ){ ?> 
                     <a href="javascript:void(0)" onclick="productComplaintLike('<?php echo $complain->product_complaint_id;?>','<?php echo $this->session->userdata('user_id'); ?>',1)">
              ...
              <?php } ?>
           <?php }else { ?> 
            <a href="javascript:void(0)" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button" >
              <svg xmlns="http://www.w3.org/2000/svg" id="Outline"  viewBox="0 0 24 24" width="24" height="24"><path d="M17.5,1.917a6.4,6.4,0,0,0-5.5,3.3,6.4,6.4,0,0,0-5.5-3.3A6.8,6.8,0,0,0,0,8.967c0,4.547,4.786,9.513,8.8,12.88a4.974,4.974,0,0,0,6.4,0C19.214,18.48,24,13.514,24,8.967A6.8,6.8,0,0,0,17.5,1.917Zm-3.585,18.4a2.973,2.973,0,0,1-3.83,0C4.947,16.006,2,11.87,2,8.967a4.8,4.8,0,0,1,4.5-5.05A4.8,4.8,0,0,1,11,8.967a1,1,0,0,0,2,0,4.8,4.8,0,0,1,4.5-5.05A4.8,4.8,0,0,1,22,8.967C22,11.87,19.053,16.006,13.915,20.313Z"/></svg> <?php echo $likeCount; ?>
           </a>
        <?php } ?>
        <?php if($this->session->userdata('user_id')){ ?>
         <a href="javascript:void(0)" id="reply-" onclick="divShow(<?php echo $complain->product_complaint_id;?>);" >
...
<div id="comment-form" class="row">
   <div class="mt-5" style="display:none" id="commentDiv_<?php echo $complain->product_complaint_id; ?>">
      <div class="alert alert-outline alert-outline-success reg-message-success" id="reg-message-success_<?php echo $complain->product_complaint_id; ?>" role="alert"  style="display:none;">
         <button type="button" class="close" data-bs-dismiss="alert" aria-hidden="true">×</button>
         <p id="text-message-success_<?php echo $complain->product_complaint_id; ?>"></p>
      </div>
      <div class="alert alert-outline alert-outline-danger reg-message-error" id="reg-message-error_<?php echo $complain->product_complaint_id; ?>" role="alert" style="display:none">
         <button type="button" class="close" data-bs-dismiss="alert" aria-hidden="true">×</button>
         <p id="text-message-error_<?php echo $complain->product_complaint_id; ?>"></p>
      </div>
      <form class="form-horizontal" name="product_complaint_reply_<?php echo $complain->product_complaint_id; ?>"  id="product_complaint_reply_<?php echo $complain->product_complaint_id; ?>" action="javascript:void(0)"  method="post">
         <?php echo csrf_field(); ?>
         ...
         <input type="hidden" class="form-control" name="complaint_id"  id="complaint_id_<?php echo $complain->product_complaint_id; ?>" placeholder="Your Name"   value="<?php echo $complain->product_complaint_id; ?>">
         <div class="form-group">
            <textarea class="form-control" name="comment" rows="6" placeholder="Comment" required="required"  maxlength="250"></textarea>
         </div>
         <?php if ($this->session->userdata('user_id')) { ?>
            <a href="javascript:void(0)" class="btn btn-primary" id="complaint_reply_submit"  onclick="productComplaintReply('<?php echo $complain->product_complaint_id; ?>')">Reply</a>
         <?php }else{ ?>
...
<div class="reply-box">
   ...
   foreach($complaint_reply as $reply){
     ?>
     <div class="review-row complaint_reply_<?php echo $reply->complaint_id; ?>" style="display: none;">
      <div class="review-user-image"><span></span></div>
      <div class="review-title-row d-flex flex-wrap justify-content-between align-items-center">
      ...
      <div class="review-content" >
         <div id="complaintReplyShort_<?php echo $reply->prr_id;?>">
            ...
            if($words > 30){
              ?>
              <small class="review-read remove-bg"><a href="javascript:void(0)" id="complaintReplyShortRM_<?php echo $reply->prr_id;?>" onclick="productComplaintReplyReadMore('<?php echo $reply->prr_id;?>')">(Read More)</a>
              </small>
           <?php } ?>
        </div>
        <div class="review-content" style="display:none" id="complaintReplyFull_<?php echo $reply->prr_id;?>"> <?php echo $reply->reply; ?> <small class="review-read remove-bg"><a href="javascript:void(0)" id="complaintReplyShortRS_<?php echo $reply->prr_id;?>" onclick="productComplaintReplyReadShort('<?php echo $reply->prr_id;?>')">(Read Short)</a></small></div>
     </div>
  </div>
<?php } ?>
</div>
