...
<div class="breadcrumb" id="breadcrumb">
  <div class="container" itemprop="breadcrumb">
    <div class="row">
      <div class="col-md-24"> <a title="Back to the frontpage" class="homepage-link" href="<?php echo base_url(); ?>">Home</a> <span>/</span> <a title="Back to the frontpage" class="homepage-link" href="<?php echo base_url(); ?>diamond">Diamond</a> <span>/</span> <span class="page-title">Diamond Details</span> </div>
    </div>
  </div>
</div>
<div id="print" class="no-print">
    ...
    <div class="container">
      <div class="row narrow-content">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12 clearfix">
          ...
          <div class="need-help">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 clearfix no-padding">
              <div class="text">
                <h4 class="text-lowercase">Question?</h4>
              </div>
              <div class="links">
                <div class="link-wrapper">  
                <a rel="nofollow" data-fallback-url="" href="tel:<?php echo SITE_PHONE ?>" style="display: inline-table;padding-right: 15px">
                    <i class="fa fa-phone"></i><span><?php echo SITE_PHONE ?> </span>
                  </a> 
                <a data-email-address="<?php echo SITE_EMAIL ?>" data-toggle="modal" data-target="#myModalinquiry" style="cursor:pointer; display: inline-table;">
        ...
        <div class="product-cart product-details-narrow col-lg-6 col-md-6 col-sm-12 col-12 clearfix">
          ...
          <div class="product-options_body clearfix wow fadeInUp" data-wow-delay="0.3s">
            ...
            <ul class="bullet-list">
              ...
              <?php if($records['0']->total_price != null){ echo '<li>Total: $'.round($records['0']->total_price).'</li>'; } ?>
          ...
          <div class="product-options_cart clearfix wow fadeInUp" data-wow-delay="0.3s">
            <div style="display: inline-block;"> 
                <a href="javascript:void(0)" onclick="choose_setting('<?php echo $records['0']->stock_id; ?>',this)" class="btn button-additional button-big text-uppercase">
                  Choose This Diamond</a>                  
            </div>
          ...
          <div class="product-options_header clearfix wow fadeInUp">
            <h3 class="font-additional font-weight-bold text-uppercase"><a id="sim" href="#slider">Similar Diamonds</a></h3>
          </div>
          ...
          <div class="product-options_footer clearfix wow fadeInUp" data-wow-delay="0.3s">
            <div class="product-options_row">
              ...
              <ul class="social-list">
                ...
                <li><a href="javascript:void(0)" class="hover-focus-border hover-focus-bg hvr-rectangle-out before-bg" id="g_plus"><span class="fa fa-google-plus" aria-hidden="true"></span></a></li>
              </ul>
            </div>
          </div> 
          ...
          <div class="modal-body">
            ...
            <form action="javascript:void(0)" method="post" enctype="multipart/form-data" id="email_form" class="form-horizontal contact-form form-design">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control radius-flat" id="name" name="name"  placeholder="Name" required="required" autofocus="">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-3" > Email :</label>
                <div class="col-md-9">
                  <input type="email" class="form-control radius-flat" id="email" name="email"  placeholder="Email" required="required">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-3" > Phone :</label>
                <div class="col-md-9">
                  <input type="text" class="form-control radius-flat" name="phone" id="phone"   maxlength="10" placeholder="Mobile No." required="required">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-3" > Comment :</label>
                <div class="col-md-9">
                  <textarea class="form-control textarea-contact radius-flat" rows="5" id="comment" name="comment" placeholder="Type Your Message/Feedback here..." required=""></textarea>
                </div>
              </div>
              <button class="btn btn-primary radius-flat"> <span class="fa fa-send"></span> Send </button>
            </form>
          </div>
          <div class="modal-footer bg-site radius-flat"> </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="myModalappointment" role="dialog" >
      ...
      <div class="form-list">
        ...
        <div class="form-schedule">
          ...
          <div class="col-lg-12 inner-form-schedule">
            <div class="form-group">
              <label class="col-md-3" > Preferred Date :</label>
              <div class="col-md-9">
      ...
      <div class="tabs-panel" role="tabpanel">
        <div class="tab-content wow fadeInUp" data-wow-delay="0.3s">
          ...
          <div id="delivery-returns" class="tab-pane fade" role="tabpanel">
            <p>We understand how important it is for you to receive your jewelry purchase promptly and safely. At Shakti Jewel, our priority is to serve your needs in the manner you request.</p>
            <ul class="bullet-list">
    ...
    <div class="container">
      <div class="starSeparatorBox clearfix">
        ...
        <div class="table-responsive cart-table">
          <table id="" class="tablesorter table display nowrap box-shadow table-bordered table-hover table-striped table-responsive table-condensed">
            <thead  class="bg-site">
              <tr>
  ...
  <?php if(isset($ring_setting_diamond_data) && !empty($ring_setting_diamond_data)){ ?>
<script>
    var ring_setting_diamond_data = 1;
</script>
<?php }else{?>
<script>
    var ring_setting_diamond_data = '';
</script>
<?php } ?>
<script src="<?php echo base_url(); ?>assets/js/ajax/ring_builder_diamond.js"></script> 
