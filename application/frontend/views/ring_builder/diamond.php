  ...
  <div itemprop="breadcrumb" class="container">
    <div class="row">
      <div class="col-md-24">
        ...
        <span>/</span>
        <span class="page-title">Loose Diamond</span>        
      </div>
    </div>
  </div>
</div>
<section class="">
    ...
    <ul class="nav nav-pills">
      <li class="active">
        <a  href="#1a" data-toggle="tab">ColorLess Diamonds</a>
      </li>
                 ...
                 <div class="row">
                         <div class="col-lg-12 col-sm-12 col-md-12 col-12">
                             ...
                             <ul class="tps_diamond_shapes" id="tps_diamond_shapes">
                                <?php if (in_array('ROUND', $ring_setting_diamond_shape)): ?>
                                  <li>
                                    <label for="idshaperound">
                                      ...
                                      <a title="Round" class=""><span class="img_shape round"><i class="icon-diamond-round"></i></span><span class="text_shape">Round</span></a></label></li>
                                <?php endif ?>
                                <?php if (in_array('PRINCESS', $ring_setting_diamond_shape)): ?>    
                                  <li>
                                ...
                                <?php endif ?>
                                <?php if (in_array('CUSHION', $ring_setting_diamond_shape)): ?>
                                  <li>
                                ...
                                <?php endif ?>
                                <?php if (in_array('RADIANT', $ring_setting_diamond_shape)): ?>
                                  <li>
                                ...
                                <?php endif ?>
                                <?php if (in_array('ASSCHER', $ring_setting_diamond_shape)): ?>
                                  <li>
                                ...
                                <?php endif ?>
                                <?php if (in_array('EMERALD', $ring_setting_diamond_shape)): ?>
                                  <li>
                                ...
                                <?php endif ?>
                                <?php if (in_array('OVAL', $ring_setting_diamond_shape)): ?>
                                 <li>
                                ...
                                <?php endif ?>
                                <?php if (in_array('PEAR', $ring_setting_diamond_shape)): ?>
                                 <li>
                                ...
                                <?php endif ?>
                                <?php if (in_array('MARQUISE', $ring_setting_diamond_shape)): ?>
                                 <li>
                                ...
                                <?php endif ?>
                                <?php if (in_array('HEART', $ring_setting_diamond_shape)): ?>
                                 <li>
                                ...
                                <?php endif ?>
                                <!-- edited by arti code start-->
                                <?php if ($ring_setting_diamond_shape == ''): ?>
                                  <li>
                                    <label for="idshaperound">
                                      <input type="checkbox" name="checkbox[]"  id="idshaperound"  onchange="submitForm()" value="Round" <?php if ($sf=='Round') { echo "checked"; } ?> >
                                      <a title="Round" class=""><span class="img_shape round"><i class="icon-diamond-round"></i></span><span class="text_shape">Round</span></a></label></li>
  ...
  <div class="table-design">
    ...
    <div class="col-sm-6 col-md-6 col-lg-6 col-12">
        ...
        <div class="row image-icon">
          <div class="col-lg-12 spacer-bottom"> 
            <nav  style="background-color: #ffffff;padding: 3px; text-align:center">
              <img src="<?php echo base_url(); ?>assets/images/download.png" onclick="export_list()" title="Download Excel" alt="Download" class="my-tooltip my-dropdown" data-toggle="tooltip" >
              ...
              <img src="<?php echo base_url(); ?>assets/images/send.png" alt="Send" onclick="send_data()" class="my-tooltip my-dropdown" title="Send Email" data-toggle="tooltip"> 
              <a href="<?php echo base_url(); ?>compare-diamond"><img src="<?php echo base_url(); ?>assets/images/compare.png" alt="Compare" class="my-tooltip my-dropdown" title="Compare" data-toggle="tooltip"> </a>  
              <a href="<?php echo base_url(); ?>ring-builder-diamond"><img src="<?php echo base_url(); ?>assets/images/refresh-icon.png" alt=Refresh"" id="refreshpage" class="my-tooltip my-dropdown" data-toggle="tooltip" title="Refresh"></a>
            </nav>
          </div>
        </div>
      </div>
     ...
     <div class="panel-body table-responsive">          
        <table id="example" class="tablesorter table display nowrap box-shadow table-bordered table-hover table-striped table-responsive table-condensed"> 
            <thead  class="">                 
                <tr>
