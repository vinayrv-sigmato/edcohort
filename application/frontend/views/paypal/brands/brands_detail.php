                        ...
                        <div class="card blog-detail">
                            <div class="card-body">
                                <div class="item7-card-img br-7 mb-5">
                                    <img src="<?php echo base_url(); ?>uploads/blog/<?php echo $blog_list[0]->blog_image; ?>" alt="<?php echo $blog_list[0]->blog_title; ?>" class="w-100">
                                ...
                                <a href="javascript:void(0)" class="text-dark"><h2 class="font-weight-semibold"><?php echo $blog_list[0]->blog_title; ?></h2></a>
                                <div class="item7-card-desc d-md-flex mb-2 mt-3">
                                    <a href="javascript:void(0)" class="font-weight-semibold fs-16"><i class="fe fe-calendar me-2 text-primary"></i><?php echo date('d M Y',strtotime($blog_list[0]->created_at)); ?></a>
                                    <a href="javascript:void(0)" class="font-weight-semibold fs-16"><i class="fe fe-user me-2 text-primary"></i>Admin</a>
                                    <div class="ms-auto">
                                        <a href="javascript:void(0)" class="font-weight-semibold fs-16"><i class="fe fe-message-circle me-2 text-primary"></i><?php echo $blog_list[0]->comment_count; ?> Comments</a>
                                    </div>
                                </div>
                                <p><?php echo $blog_list[0]->blog_dec; ?></p>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body">
                               ...
                               <?php foreach($blog_comment_list as $comment){ ?>
