  ...
  <section id="productDetails" class="product-detail">
    <div class="container">
      <div class="row narrow-content">
        <div class="col-lg-4 col-md-4 col-sm-12 col-12 clearfix">
    ...
    <tbody>
                                ...
                                <tr>
                                    <th>&nbsp;Lab</th>
                                    <td class="color-orange">&nbsp;<?php if($records['0']->lab != null){echo $records['0']->lab; }?></td>
                                </tr>

                                <?php if($records['0']->stock_id != null){ echo '
                                <tr>
                                    <th>&nbsp;Stock#</th>
                                    <td>&nbsp;'.$records['0']->stock_id.'</td>
                                </tr>'; }  ?>

                                <?php if($records['0']->shape_full != null){ echo '
                                <tr>
                                    <th>&nbsp;Shape</th>
                                    <td>&nbsp;'.$records['0']->shape_full.'</td>
                                </tr>'; }  ?>


                                <?php if($records['0']->weight != null){ echo '
                                <tr>
                                    <th>&nbsp;Cts</th>
                                    <td>&nbsp;'.number_format($records['0']->weight,2).'</td>
                                </tr>'; }  ?>

                                       <?php if($records['0']->color != null){ echo '
                                <tr>
                                    <th>&nbsp;Color</th>
                                    <td>&nbsp;'.$records['0']->color.'</td>
                                </tr>   '; } ?>      

                                    <?php if($records['0']->grade != null){ echo '                  
                                <tr>
                                    <th>&nbsp;Clarity</th>
                                    <td >&nbsp;'.$records['0']->grade.'</td>
                                </tr>'; } ?>   

                                   <?php if($records['0']->cut_full != null){ echo '
                                <tr>
                                    <th>&nbsp;Cut</th>
                                    <td>&nbsp;'.$records['0']->cut_full.'</td>
                                </tr>'; } ?>   

                                <?php if($records['0']->polish_full != null){ echo '
                                <tr>
                                    <th>&nbsp;Polish</th>
                                    <td>&nbsp;'.$records['0']->polish_full.'</td>
                                </tr>'; } ?>   

                                 <?php if($records['0']->symmetry_full != null){ echo '
                                 <tr>
                                    <th>&nbsp;Symmetry</th>
                                    <td>&nbsp;'.$records['0']->symmetry_full.'</td>
                                </tr>'; } ?>   

                                 <?php if($records['0']->fluor_full != null){ echo '
                                <tr>
                                    <th>&nbsp;Fluorescence</th>
                                    <td>&nbsp;'.$records['0']->fluor_full.'</td>
                                </tr>'; } ?>   


                                 <?php if($records['0']->depth != null){ echo '
                                <tr>
                                    <th>&nbsp;Depth%</th>
                                    <td>&nbsp;'.number_format($records['0']->depth,1).'</td>
                                </tr>'; } ?>

                                <?php if($records['0']->table_d != null){ echo '
                                <tr>
                                    <th>&nbsp;Table%</th>
                                    <td>&nbsp;'.(int)$records['0']->table_d.'</td>
                                </tr>'; } ?> 
                                <?php if($records['0']->new_discount != null){ echo '
                                <tr>
                                    <th>&nbsp;Disc%</th>
                                    <td class="color-red">&nbsp;'.$records['0']->new_discount.'</td>
                                </tr>'; } ?> 
                                <?php if($records['0']->cost_carat != null){ echo '
                                <tr>
                                    <th>&nbsp;$/Carat</th>
                                    <td class="color-green">&nbsp;'.(int)$records['0']->cost_carat.'</td>
                                </tr>'; } ?>
                             <?php if($records['0']->total_price!=null){ echo '
                                <tr>
                                    <th>&nbsp;Total Amount</th>
                                    <td class="color-orange">&nbsp;$'.(int)$records['0']->total_price.'</td>
                                </tr>'; }  ?>
             

                                <?php if($records['0']->measurements != null){ echo '
                                <tr> 
                                    <th>&nbsp;Measurements</th>
                                    <td>&nbsp;'.$records['0']->measurements.'</td>
                                </tr>'; } ?>


                                <?php if($records['0']->girdle_thin != null){ echo '
                                <tr>
                                      <th>&nbsp;Girdle Thin</th>  
                                      <td>&nbsp;'.$records['0']->girdle_thin.'</td>
                                    </tr>'; } ?>


                                  <?php if($records['0']->girdle_thick != null){ echo '
                                    <tr>
                                      <th>&nbsp;Girdle Thick</th>  
                                      <td>&nbsp;'.$records['0']->girdle_thick.'</td>
                                    </tr>'; } ?>

                                  <?php if($records['0']->culet != null){ echo '
                                    <tr>
                                      <th>&nbsp;Culet</th>
                                      <td>&nbsp;'.$records['0']->culet.'</td>
                                    </tr>'; } ?>
                                    

                                    <?php if($records['0']->shade != null){ echo '
                                    <tr>
                                      <th>&nbsp;Shade</th>  
                                      <td>&nbsp;'.$records['0']->shade.'</td>
                                    </tr>'; } ?>


                                    <?php if($records['0']->crown_ht != null){ echo '
                                    <tr>
                                      <th>&nbsp;Crown Height</th>  
                                      <td>&nbsp;'.$records['0']->crown_ht.'</td>
                                    </tr>'; } ?>


                                       <?php if($records['0']->crown_angle != null){ echo '
                                    <tr>
                                      <th>&nbsp;Crown Angle</th>  
                                      <td>&nbsp;'.$records['0']->crown_angle.'</td>
                                    </tr>'; } ?>


                                    <?php if($records['0']->pavillion_angle != null){ echo '
                                    <tr>
                                      <th>&nbsp;Pavilion Angle</th>  
                                      <td>&nbsp;'.$records['0']->pavillion_angle.'</td>
                                    </tr>'; } ?>

                                     <?php if($records['0']->pavillion_depth != null){ echo '

                                    <tr>
                                      <th>&nbsp;Pavilion Depth</th>  
                                      <td>&nbsp;'.$records['0']->pavillion_depth.'</td>
                                    </tr>'; } ?>


                                    <?php if($records['0']->keytosymb != null){ echo '
                                    <tr>
                                      <th>&nbsp;Key To Symbols</th>  
                                      <td>&nbsp;'.$records['0']->keytosymb.'</td>
                                    </tr>'; } ?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-12 clearfix">
          ...
          <div class="quick-img">
            ...
            <div class="box_price clearfix">
             ...
             <!--  <img src="<?php echo base_url(); ?>assets/images/back-icon.png" alt="Back" class="my-tooltip my-dropdown pull-right" data-toggle="tooltip"  onclick="window.history.back()" data-placement="top" title="Back" data-tooltip="true"> -->
               </h3>
              ...
              <div class="product-price font-additional font-weight-normal customColor">$
                ...
                <?php if($records['0']->currency!=""){ echo round($records['0']->currency); } ?>
                        ...
                        <!-- <span><?php if($records['0']->weight != null){ echo number_format($records['0']->weight,2); }  ?>  <?php if($records['0']->color != null){ echo $records['0']->color; } ?>  <?php if($records['0']->grade != null){ echo $records['0']->grade; } ?></span>
                        <br>
                        <span class="discount color-red">DIS: <?php if($records['0']->new_discount != null){ echo round($records['0']->new_discount,2); }  ?>%</span>
                        <br>
                        <span><?php if($records['0']->currency != null){ echo round($records['0']->currency,2); } ?> BAHT</span>
                        <br>
        ...
        <div class="product-cart product-details-narrow col-lg-4 col-md-4 col-sm-12 col-12 clearfix">
             ...
             <?php //$count++; } ?> -->
              ...
              <?php foreach($video_link as $k => $value){  ?>
              <li class="" id="slides_<?php echo $count; ?>" style="height: 375px;">
                <iframe src="<?php echo $value; ?>" frameborder="0" width="100%" height="100%"></iframe>
              </li>
              <?php $count++; } ?>
            </ul>
      ...
      <div>
        <embed src= "<?php echo $records['0']->report_filename;  ?>" width= "100%" height= "670">
      </div>
    </div>
