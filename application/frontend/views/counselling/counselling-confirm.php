    ...
    <div class="counselling-detail-box">
        <div class="container">
            ...
            <div class="counselling-date-box">
                <div class="calendar-main-box d-flex justify-content-between g-4">
                    ...
                    <div class="select-time-box">
                        ...
                        <a href="javascript:void(0)" class="time-btn" data-bs-dismiss="modal" data-bs-toggle="modal"
                            ...
                            <div class="card">
                                <div class="form">
                                    <div class="right-side">
                                        ...
                                        <div class="input-text">
                                            <input type="text" id="user_card_number_input"
                                                placeholder="0000 0000 0000 0000" onkeyup="userCardNumber(this.value)"
                                                data-slots="0" data-accept="\d" require>
                                            <span>Card number</span>
                                        </div>
                                        <div class="input-div">
                                            <div class="input-text">
                                                <input type="text" onkeyup="usercardcvv(this.value)"
                                                    placeholder="MM/YYYY" data-slots="MY" require>
                                                <span>Valid upto</span>
                                            </div>
                                            <div class="input-text ">
                                                <input type="text" placeholder="000" data-slots="0" data-accept="\d"
                                                    size="3" require>
                                                <span>CVV</span>
                                            </div>
                                        </div>
            ...
            <form action="<?php echo base_url(); ?>counselling-submit" method="post" enctype="multipart/form-data">
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" class="form-control" name="counselling_id" id="counselling_id"
                    placeholder="Your Name" value="<?php echo $this->uri->segment(2); ?>">
                <input type="hidden" class="form-control" name="user_id" id="userid" placeholder="Your Name"
                ...
                <div class="reply-footer-right">
                    <button type="submit" data-bs-effect="effect-scale" data-bs-toggle="modal"
                        data-bs-target="#rateModal" class="reply-footer-btn">Submit</button>
                </div>
                <?php }else{ ?>
                <div class="reply-footer-right">
                    <a href="javascript:void(0)" class="reply-footer-btn" data-bs-effect="effect-scale"
                        data-bs-toggle="modal" data-bs-target="#login-button">Submit</a>
                </div>
                <?php } ?>
            </form>
            <?php } ?>
