...
<div class="review-center">
            ...
            <?php if($this->session->userdata('user_id')){ ?>
               <a href="<?php echo base_url(); ?>create-a-counselling?course=<?php echo @$course; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&pickupdate=<?php echo $c_date; ?>&sort_by=<?php echo $sort_by; ?>" class="review-btn"> Get counselling
               </a>
            <?php } else{ ?>
               <a href="javascript:void(0)" class="review-btn" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button">Get counselling
              </a>
           <?php } ?>
        </div>
        ...
        <?php if(!empty($cdate)){ ?> 
            <div class="availability-col"><a href="javascript:void(0)"><?php echo date('d-M-Y',strtotime($cdate)); ?> You are Selected </a></div>
        <?php } ?>
        <div class="counselling-col-box d-flex flex-wrap">
            <!--col-->
                     ...
                     <?php } ?>
                        ...
                        <div class="counselling-col-content">
                            <div class="content-top-row d-flex justify-content-between align-items-start">
                                <div class="top-left"><h3><?php echo ucwords($counselling->firstname); ?></h3> <p><?php echo ucwords($counselling->brand_name); ?></p></div>
                            ...
                            <a href="<?php echo base_url(); ?>counselling-confirm/<?php echo $counselling->c_id;  ?>" class="book-btn">Book now</a>
                      <!--   <?php if($this->session->userdata('user_id')){ ?>
...
<!-- Modal -->
<div class="modal fade calendar-modal" id="dateModal" tabindex="-1" aria-labelledby="dateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">

            <div class="modal-body">

                <h2 class="date-title"><span>Please select confirm your availability by selecting date and time</span></h2>
                <div class="calendar-main-box d-flex justify-content-between">
                    ...
                    <div class="select-time-box">
                        ...
                        <div class="time-box">
                            <input class="form-control" id="tpBasic" placeholder="Set time" name="start_time" type="text">
                        </div>
...
<!-- Modal -->
<div class="modal fade calendar-modal" id="TimeModal" tabindex="-1" aria-labelledby="TimeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
