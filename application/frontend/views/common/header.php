...
<link href="https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,100;9..40,300;9..40,400;9..40,500;9..40,700&display=swap" rel="stylesheet">
    <!--plugin css-->
    ...
    <link href="<?php echo base_url(); ?>assets/css/owlcarousel/wl.theme.default.min.css" type="text/css" rel="stylesheet">
 ...
 $(document).ready(function() {
    ...
    <div class="wrapper">
        ...
        <div class="header d-flex justify-content-between align-items-center " id = "myHeader">
            ...
            <!--logo-->
            <div class="logo">
                <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/images/top_logo.webp" alt="Edcohort"></a>
            </div>
