   ...
   <div class="container ">
       <div class="row">
        <div class="col-md-12 footer-icons pt-3">
            ...
            <i class="fa-brands fa-square-twitter fa-lg icon-align "> <span class="upper-cnct-font"> support_edcohort  </span></i>
        </div>
       </div>
   </div>
        ...
        <div class="container ">
           <div class="row pb-3">
            <div class="col-md-10 pt-3">
                <div class="footer-logo">Copyright © 2023. All Rights Reserved by Edcohort. Designed & Developed by Sigmato Solution Pvt Ltd </div>
