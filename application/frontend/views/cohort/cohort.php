                    ...
                    <div class="btn-group btn-toggle filter-toggle-box">
                        <div class="input-toggle <?php if(@$product_list['0']->product_type == 1){ echo 'active';} ?>"
                            ...
                            <input class="btn btn-lg btn-default" type="radio" name="product_type"
                                <?php if(@$product_list['0']->product_type == 1){ echo 'checked';} ?> id="online"
                        ...
                        <div class="input-toggle <?php if(@$product_list['0']->product_type == 2){ echo 'active';} ?>"
                            ...
                            <input class="btn btn-lg btn-primary active" type="radio" name="product_type"
                                <?php if(@$product_list['0']->product_type == 2){ echo 'checked';} ?> id="offline"
                                value="2" onClick="prodcutType(2)">
                        </div>
                    </div>
        ...
        <div class="review-center main-content">
            ...
            <div class="review-btn-box">
                <a href="<?php echo base_url(); ?>create-cohort?course=<?php echo @$course; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>"
                    class="review-btn"> <img src="<?php echo base_url();?>assets/images/review-icon2.png" alt="">
                    Create
                    a discussion</a>
            </div>
            <?php }else{ ?>

            <a href="javascript:void(0)" class="review-btn" data-bs-effect="effect-scale" data-bs-toggle="modal"
                data-bs-target="#login-button"> <img src="<?php echo base_url();?>assets/images/review-icon2.png"
                    alt=""> Create a discussion</a>
            <?php } ?>
                    ...
                    <div class="across-left">
                        <div class="standard-box">
                            ...
                            <a href="<?php echo base_url(); ?>cohort-group/<?php echo $group->cg_id;?>">
                                <div class="standard-footer"><button type="button" class="join-btn">Join</button>
                                </div>
                            </a>
                            <?php }else{ ?>

                            <a href="javascript:void(0)" class="standard-footer" data-bs-effect="effect-scale"
            ...
            <div class="across-row">
                ...
                <ul class="room-list-box discussion-room-list d-flex flex-wrap justify-content-between">
                    ...
                    <li class="room-list">
                        ...
                        <a href="javascript:void(0)" class="standard-footer anchor" data-bs-effect="effect-scale"
                            data-bs-toggle="modal" data-bs-target="#login-button"></a>
                    ...
                    <li class="room-list btn-room-list">
                        <a href="<?php echo base_url(); ?>create-cohort?course=<?php echo @$course; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>"
                            class="discussion-btn"> <img src="<?php echo base_url();?>assets/images/review-icon2.png"
                                alt=""> Create a
                            discussion</a>
                    </li>
                    <?php }else{ ?>
