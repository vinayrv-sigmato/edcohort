...
<div class="inner-banner">
   ...
   <div class="tab-menu">
      <ul>
         <li><a href="<?php echo base_url(); ?>complaint?course=<?php echo @$course; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Complain </a></li>
        ...
        <?php if($this->session->userdata('user_id')){ ?>
                ...
                <div class="across-col-box d-flex justify-content-between">
                    ...
                    <div class="across-right">
                        ...
                        foreach($group_list as $group){ 
                            ...
                            <?php if($this->session->userdata('user_id')){ ?>
                                <a href="<?php echo base_url(); ?>view-cohort-group/<?php echo $group->cg_id;?>"><?php echo $group->tag; ?></a>
                            <?php }else{ ?>
                               
                                <a href="javascript:void(0)" class="standard-footer" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button"><?php echo $group->tag; ?></a>
                            <?php } ?>
            ...
            <div class="across-row">
                ...
                <?php //print_ex($ongoing_group_list);
                    ...
                    <li class="room-list">
                        <?php if($this->session->userdata('user_id')){ ?>
                            <a href="<?php echo base_url(); ?>view-cohort-group/<?php echo $ongoinggroup->cg_id;?>"><?php echo $ongoinggroup->tag; ?></a>
                        <?php }else{ ?>
