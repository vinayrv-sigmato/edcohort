...
<div class="col-md-3 breadcrumb-design">
   ...
   <div class="tab-menu">
      <ul>
         <li><a href="<?php echo base_url(); ?>complaint?course=<?php echo @$course; ?>&segment=<?php echo $segment; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Complaint </a></li>
         ...
         <li class="active"><a href="<?php echo base_url(); ?>review?course=<?php echo @$course; ?>&segment=<?php echo $segment; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Reviews <?php echo $review_count; ?></a></li>
    ...
    <!--- Filtr Starts  --->
        ...
        <div class="review-inner-center">
         <div class="tab-link">
            ...
            <ul>
               <li>
                  <a href="<?php echo base_url(); ?>review?course=<?php echo $course; ?>" class="active">All</a>
               </li>
               ...
               <?php } else{  ?>
                  <li>
                    <a href="javascript:void(0)"  data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button">My Review</a>
                 </li>
              <?php } ?>
              <?php if($this->session->userdata('user_id')){ ?>
               <li>
                  <a href="<?php echo base_url(); ?>my-review-reply?course=<?php echo $course; ?>">My Replies</a>
               </li>
            <?php } else{ ?>
             <li>
              <a href="javascript:void(0)" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button">My Replies</a>
           </li>
...
<div class="review-box">
   <?php if($review_list){ ?>
      <?php foreach($review_list as $review){?>
         ...
         if($words > 30){?>
            <div class="review-read" id="review-read_<?php echo $review->product_review_id;?>">
               <a href="javascript:void(0)" id="reviewShortRM_<?php echo $review->product_review_id;?>" onclick="productReviewReadMore('<?php echo $review->product_review_id;?>')">(Read more)</a>
            </div>
         <?php } ?>
         <div class="review-content" style="display:none" id="reviewFull_<?php echo $review->product_review_id;?>"><?php echo $review->product_review; ?> 
         <div class="review-read">
            <a href="javascript:void(0)" id="reviewShortRS_<?php echo $review->product_review_id;?>" onclick="productReviewReadShort('<?php echo $review->product_review_id;?>')">(Read Short)</a>
         </div>
      </div>
      <hr />
      <div class="review-footer d-flex flex-wrap justify-content-between align-items-center">
         ...
         <?php } else{ ?>
            <div class="review-footer-left"><?php echo sizeof($review_reply); ?> Replies <a href="javascript:void(0)" onclick="viewRepliesAll('<?php echo $review->product_review_id;?>')" class="view-all-replies">View all replies</a></div>
         <?php } ?>
         <div class="review-footer-right d-flex">
            ...
            <?php } ?>
            <?php if($this->session->userdata('user_id')){ ?>
               <a href="javascript:void(0)" id="reply-" onclick="divShow(<?php echo $review->product_review_id;?>);" >
      ...
      <div class="reply-box">
                     ...
                     foreach($review_reply as $reply){ ?>
                        <div class="review-row-reply review_reply_<?php echo $reply->review_id;?>" style="display:none">
                           <div class="review-user-image"><span></span></div>
                           <div class="review-title-row d-flex flex-wrap justify-content-between align-items-center">
                           ...
                           <div class="review-content" >
                             ...
                             <div class="review-content" style="display:none" id="reviewReplyFull_<?php echo $reply->prr_id;?>"> <?php echo $reply->reply; ?> <small class="review-read remove-bg"><a href="javascript:void(0)" id="reviewReplyShortRS_<?php echo $reply->prr_id;?>" onclick="productReviewReplyReadShort('<?php echo $reply->prr_id;?>')">(Read Short)</a> </small></div>
                          </div>
                       </div>
                    <?php } ?>
                 </div>
