        ...
        <div class="review-inner-center">
         <div class="tab-link">
            <ul>
                ...
                <li>
                    <a href="<?php echo base_url(); ?>my-review?course=<?php echo $course; ?>" class="active">My Review</a>
                </li>
                <li>
            ...
            <?php if($review_list){ ?>
                <?php foreach($review_list as $review){?>
                    ...
                    <div class="review-row">
                        ...
                        <div class="review-content" style="display:none" id="reviewFull_<?php echo $review->product_review_id;?>"> <?php echo $review->product_review; ?> <small class="text-yellow"><a href="javascript:void(0)" id="reviewShortRS_<?php echo $review->product_review_id;?>" onclick="productReviewReadShort('<?php echo $review->product_review_id;?>')">(Read Short)</small></a> </div>

                        <div class="review-footer d-flex flex-wrap justify-content-between align-items-center 129">
                            <?php 
