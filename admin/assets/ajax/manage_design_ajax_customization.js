$(document).ready(function(){
    var url=base_admin+'design_customization/load_more_data?page='; 
    pagination(url);
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                {                   
                   ...
                   html +='    <td>';  
                   html +='      <a class="btn btn-default" href="'+base_admin+'design/design_details/'+details[i].design_id+'">';                                     
                   html +='        <i class="fa fa-search-plus"  title="View details" data-toggle="tooltip" style=""></i>';
                   html +='      </a>';
                   html +='      <a  class="btn btn-primary" href="'+base_admin+'design_customization/design_edit/'+details[i].design_id+'">';                                     
                   html +='        <i class="fa fa-edit"  title="Edit details" data-toggle="tooltip" style=""></i>';
                   html +='      </a>';
                   html +='      <a href="'+base_admin+'design_customization/delete/'+details[i].design_id+'" onclick="return confirm('+co_text+')">';                                     
                  ...
                  // html +='    <td>';
                   ...
                   //  html +='    <td>'+frame+' </td>';
                   //  if(details[i].budget != null){ var budget=details[i].budget; }else{ var budget=""; }
                   //  html +='    <td>'+budget+' </td>';
      ...
      {     
         ...
         bootbox.confirm({
            ...
            callback: function (result) {
                ...
                {
                    $.ajax({
                        url: base_admin+'diamond/delete_diamond',
                        dataType: 'json',
                        type: 'get',            
 ...
 function print_data()
     ...
     //alert('print data');
        ...
        if(checkbox_arr.length)
        {
            ...
            $.ajax({
            url: base_admin+'diamond/print_data',
            dataType: 'json',
            type: 'get',            
            data: { "all_id": checkbox_arr },            
            success: function(data){
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   {    
        ...
        if(checkbox_arr.length)
        {
            //alert(checkbox_arr.length);
            $.ajax({
            url: base_admin+'diamond/download_file',
            dataType: 'json',
            type: 'get',            
            data: { "all_id": checkbox_arr },            
            success: function(data){
...
function export_list()
{
  ...
  if(checkbox_arr.length)
  {
      location.href=base_admin+'diamond/export_diamond?all_id='+checkbox_arr    
  }
  else
  {
      if(confirm('Do You Want To Download All Record ?'))
      {
          location.href=base_admin+'diamond/export_diamond?all_id='
      }
