$(document).ready(function(){ 
    var url=base_url+'admin_contact/loadData?page='; 
    pagination(url);
...
function submitForm() {
    ...
    var set_url=base_url+'admin_contact?'+value_form;
               ...
               for(i=0;i<details_length;i++) { 
                ...
                if(details[i].date_edited!=null){ date_edited=moment(details[i].date_edited).format('MMM Do YYYY'); }else{ date_edited=''; }               
                  ...
                  //  html +='                <label for="basic_'+details[i].customer_id+'"></label></td>';   
                    ...
                    //html +='            <td>'+moment(details[i].date).format('MMM Do YYYY')+'</td>'; 
                   // html +='            <td>'+details[i].time+'</td>';         
