$(document).ready(function(){ 
    var url=base_url+'admin_enquiry/loadData?page='; 
    pagination(url);
...
function submitForm() {
    ...
    var set_url=base_url+'admin_enquiry?'+value_form;
            ...
            success: function(data){ 
               ...
               for(i=0;i<details_length;i++) { 
                ...
                if(details[i].date_edited!=null){ date_edited=moment(details[i].date_edited).format('MMM Do YYYY'); }else{ date_edited=''; }               
                    html +='<tr id="tr_'+details[i].appointment_id+'">';
                  ...
                  //  html +='                <label for="basic_'+details[i].customer_id+'"></label></td>';   
                    html +='            <td><strong>'+details[i].stock+'</strong></td>';
                     html +='            <td><strong>'+details[i].stock_name+'</strong></td>';
                    html +='            <td>'+details[i].type+'</td>'; 
                    html +='            <td><strong>'+details[i].name+'</strong></td>';    
                    html +='            <td>'+details[i].email+'</td>';       
                    html +='            <td>'+details[i].mobile+'</td>';       
                    html +='            <td>'+details[i].message+'</td>'; 
                    html +='            <td>'+details[i].description+'</td>';
                    html +='            <td>'+moment(details[i].created_date).format('MMM Do YYYY')+'</td>';         
