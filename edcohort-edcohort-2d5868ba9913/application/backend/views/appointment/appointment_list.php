<section class="content">
    <div class="container-fluid">
        <div class="row row-header">
            <div class="col-md-8">
            <h2>Appointment <small>Appointment List</small></h2>
            </div>
            <div class="col-md-4">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="body ">
                ...
                <div class="row clearfix col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">                        
                        <a href="<?php echo base_url() ?>admin_appointment" class="btn bg-red btn-block waves-effect" ><i class="material-icons">refresh</i><span>RESET</span></a>
                    </div>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="header">
                        <span class="header_span">Appointment List</span>
...
<script src="<?php echo base_url(); ?>assets/ajax/manage_appointment_ajax.js"></script>
