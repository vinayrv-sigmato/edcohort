                                    ...
                                    <div class="card-body mb-0">
                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin_type/edit_type_submit" method="post" enctype="multipart/form-data">
                                            <div class="form-group ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label" id="examplenameInputname2">Type Name</label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="type_name" name="type_name" value="<?php echo $type->title; ?>" placeholder="Enter Name" required onkeyup="category_slug_name(this.value)">
                                                    </div>
                                                </div>
                                            </div>
