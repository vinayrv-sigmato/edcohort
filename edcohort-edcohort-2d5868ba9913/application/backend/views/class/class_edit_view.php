                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin_class/edit_class_submit" method="post" enctype="multipart/form-data">
                                            <div class="form-group ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="class_name" name="class_name" value="<?php echo $class->title; ?>" placeholder="Enter Name" required onkeyup="category_slug_name(this.value)">
                                                    </div>
                                                </div>
                                            </div>
