                ...
                <div class="card">
                    ...
                    <div class="body">
                      ...
                      <div class="col-12">                              
                        ...
                        <div class="col-md-9">
        <form action="<?php echo base_url(); ?>admin_diamond/upload_diamond_submit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            <?php echo csrf(); ?> 
                            <div class="form-group form-design">
                              <label class="control-label col-md-3 col-sm-3 col-12">Select vendor of file</label>
                              <div class="col-md-9 col-sm-9 col-12">
                                  <select class="form-control" name="vendor" required>
                                      <option value="">Select Vendor</option>
                                      <?php foreach($vendors as $vendor){ ?>
                                      <option value="<?php echo strtolower(str_replace(" ",'-',$vendor->NM_COMPANY_NAME)) ?>"><?php echo $vendor->NM_COMPANY_NAME; ?></option>
                                      <?php } ?>
                                  </select>
                              </div>
                            </div>
                    ...
                    <div class="body">
                      ...
                      <div class="col-12">                              
                        ...
                        <div class="col-md-9">
                             ...
                             <form action="<?php echo base_url(); ?>admin_diamond/upload_diamond_image" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="body">
                      ...
                      <div class="col-12">                              
                         ...
                         <div class="col-md-9">
                           ...
                           <form action="<?php echo base_url(); ?>admin_diamond/upload_diamond_video" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="body">
                      ...
                      <div class="col-12">                              
                         ...
                         <div class="col-md-9">
                           ...
                           <form action="<?php echo base_url(); ?>admin_diamond/upload_diamond_certificate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
