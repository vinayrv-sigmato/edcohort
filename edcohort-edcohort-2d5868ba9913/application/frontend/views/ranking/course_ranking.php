							...
							<aside class="app-sidebar doc-sidebar my-dash">
								<div class="app-sidebar__user clearfix">
									<ul class="side-menu">
										...
										<li class="slide">
											<a class="side-menu__item slide-show" href="javascript:void(0)"><i class="side-menu__icon fe fe-settings"></i><span class="side-menu__label">Cohort Detail</span><i class="angle fa fa-angle-right"></i></a>
											<ul class="slide-menu">
												<li><a class="slide-item" href="#"><i class="fa fa-angle-right me-2"></i>Live</a></li>
											</ul>
										</li>
									</ul>
								</div>
									...
									<table class="table card-table table-bordered table-hover table-vcenter text-nowrap text-center">
										<tr>
											<thead class="bg-primary">
												<td colspan="2" class="text-white">Ranking</td>
