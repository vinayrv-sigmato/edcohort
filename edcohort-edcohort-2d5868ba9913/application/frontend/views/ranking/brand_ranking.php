			...
			<div class="container">
				<div class="page-header">
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Brand Wise Ranking</li>
					</ol>
				</div>
			</div>
		</div>
								...
								<div class="app-sidebar__user clearfix">
									<ul class="side-menu">
										<li class="slide">
											...
											<ul class="slide-menu">
												<?php foreach($class_records as $class_rec){ ?> 
												<li><a class="slide-item" href="<?php echo base_url().'brand-wise-ranking/'.$getbrand.'?course='.$class_rec->class_id; ?>"><i class="fa fa-angle-right me-2"></i><?php echo $class_rec->title; ?></a></li>	
												<?php } ?>
											</ul>
										</li>
									</ul>
							...
							<div class="card mb-0 border-0 shadow-none p-5">
								...
								<div class="table-responsive ranking-table">
									<table class="table card-table table-bordered table-hover table-vcenter text-nowrap text-center">
										...
										<?php foreach($brand_records as $rec){ ?> 
											<tr>
												<td><?php echo $rec->last_month; ?></td>
												<td><?php echo $rec->current_month; ?></td>
