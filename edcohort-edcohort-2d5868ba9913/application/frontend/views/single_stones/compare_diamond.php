...
<div class="breadcrumb ">  
   <div class="container">
    ...
    <div> <h2><span>Compare Diamond</span></h2></div>
     <div><ul class="nav">
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">Compare Diamond</a>
      </li>
    </ul></div>
     </div>
   </div>
...
<div class="row">
  <div class="container">
   <button type="button" class="btn main-btn radius-flat pull-right mt-4" onclick="window.history.back()"><i class="fa fa-reply"></i> Back</button>
 </div>
</div>
    ...
    <div class="container-fluid ">
      ...
      <div class="starSeparatorBox clearfix text-center ">
          <div class="diamond column labels" id="add_data">
            ...
            <div class="c_head"><span>Disc%</span></div>
            <div class="c_head"><span>$/Carat</span></div>
            ...
            <div class="c_head"><span>Origin</span></div>
            <div class="c_head"><span>Availability</span></div>
          </div>
