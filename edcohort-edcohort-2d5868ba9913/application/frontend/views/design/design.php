...
<?php echo message(); ?>
    <section class="border-bottom-light sm-text-center">
        ...
        <form id="form-project-planner" class="form-horizontal" name="thisform" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>design-submit">
          <?php echo csrf_field(); ?>  
          <div class="row">
              <div class="col-md-6 ">
                  ...
                  <div class="form-group">
                    <input  class="form-control " placeholder="Company/Organization*" id="company" required="" name="company" value="<?php echo @$record[0]->NM_COMPANY; ?>">
                  </div>
                  <div class="form-group">
                    <input class="form-control " placeholder="Full Name*" required="" id="name" name="name"  type="text" value="<?php echo @$record[0]->NM_USER_FULLNAME; ?>">
                  </div>
                  <div class="form-group">
                    <input class="form-control " placeholder="Email Address*" id="email"  name="email" required="" type="email" value="<?php echo @$record[0]->NM_USER_EMAIL; ?>">
                  </div>
                  <div class="form-group">
                    <input class="form-control " placeholder="Phone Number*" required="" id="contact" value="<?php echo @$record[0]->SN_USER_MOBILE; ?>" name="contact" maxlength="12" type="phone" >
                  </div>
                  <div class="form-group">
                    <input class="form-control " placeholder="Reference Number*" required="" id="reference_number" value="" name="reference_number" maxlength="12">
                  </div>
                  <div class="form-group">
                    <input class="form-control " placeholder="Remark" required="" id="remark" value="" name="remark" >
                  </div>
              </div>
              ...
              <div class="col-md-6 ">
                  ...
                  <div class="form-group">
                    <input class="form-control " placeholder="What is your Finger Size?" id="size" value="" name="size">
                  </div>
                  <div class="form-group">
                    <input class="form-control " placeholder="Metal?" id="metal" value="" name="metal">
                  </div>
                  <div class="form-group">
                    <input class="form-control " placeholder="Center shape/size?" id="center_diamond" value="" name="center_diamond">
                  </div>
