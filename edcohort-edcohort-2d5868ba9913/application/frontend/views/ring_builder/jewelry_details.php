            ...
            <div class="product-cart product-details-narrow col-lg-6 col-md-6 col-sm-12 col-12 clearfix">                                                 
              ...
              <div class="product-options_cart clearfix wow fadeInUp" data-wow-delay="0.3s" style="padding-bottom: 10px;">
                ...
                <div style="display: inline-block;"> 
                    <a href="javascript:void(0)" onclick="choose_setting('<?php echo $records['0']->product_id; ?>',this)" class="btn button-additional button-big text-uppercase">
                      Choose This Setting</a>                  
                </div>

                <?php if($records['0']->product_is_get_quote=="1"){ ?>      
                <div class="" style="display: inline-block;"> 
                    <a href="javascript:void(0)" onclick="get_quote_modal('<?php echo $records['0']->product_id; ?>',this)" class="btn button-additional button-big text-uppercase">
                  ...
                  <ul class="product-links" style="padding-bottom: 0">
                    ...
                    <li>
                      <a href="#" data-toggle="modal" data-target="#myModaljewelry" class="font-additional font-weight-normal hover-focus-color">
                        <span class="fa fa-envelope" aria-hidden="true"></span> email to friend
                      </a>
                    </li>
        ...
        <div class="container">
          <div class="starSeparatorBox clearfix">
            ...
            <div class="product-div product-bg position-relative product-overlay">
              <a href="<?php echo base_url(); ?>ring-builder-details/<?php echo $row->product_slug; ?>">
            ...
            <div class="card-body">
                    <h4 class="card-title">
                        <a href="<?php echo base_url(); ?>ring-builder-details/<?php echo $row->product_slug; ?>"><?php if($row->product_name!=""){ echo $row->product_name;} ?></a>
                    </h4>
   ...
   $(document).ready(function () {   
    $('#cart_metal_type').on('change', function() {
        ...
        if(metal_type == 'Platinum'){
          ...
          $("#cart_metal_color").addClass("intro");
          //$("#cart_metal_color").prop("disabled", false);
        }else{
          $("#cart_metal_color").removeClass("intro");
           //$("#cart_metal_color").prop("disabled", false);
        }
    });

     $('input[name="addon_name_engraving[engraving_fee]"]').attr('maxlength', 25);
});
</script>