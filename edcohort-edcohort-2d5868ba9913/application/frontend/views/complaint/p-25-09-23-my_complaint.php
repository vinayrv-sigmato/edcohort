...
<div class="inner-banner">
    ...
    <div class="tab-menu">
        <ul>
            <li class="active"><a href="<?php echo base_url(); ?>complaint?course=<?php echo @$course; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Complain <?php echo $complaint_count; ?></a></li>
    ...
    <div class="review-main-box d-flex">
        ...
        <div class="review-center">
            ...
            <!-- <div class="review-btn-box">
                <a href="write-a-review.html" class="review-btn"><img src="images/review-icon2.png" alt=""> Write a
                    review</a>
                </div> -->
                <div class="review-inner-center">
                    <div class="tab-link">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>my-complaint?course=<?php echo $course; ?>" class="active">My Complains</a>
                            </li>    
                        </ul>
                    </div>
                    <div class="total-review">
                        <?php echo $complaint_count;?> Complaint<?php if($complaint_count > 1){ echo "s"; } ?> 
                    </div>
                    <div class="review-box">
                        <?php if($complaint_list){ ?>
                            <?php foreach($complaint_list as $complain){?>
                                ...
                                <div class="review-content" style="display:none" id="complaintFull_<?php echo $complain->product_complaint_id;?>"> <?php echo $complain->product_complaint;?> <small class="text-yellow">
                                    <a href="javascript:void(0)" id="complaintShortRS_<?php echo $complain->product_complaint_id;?>" onclick="productComplaintReadShort('<?php echo $complain->product_complaint_id;?>')">(Read Short)</small></a> </div>
                                    ...
                                    <div class="review-footer d-flex flex-wrap justify-content-between align-items-center">
                                        ...
                                        ?>
                                        <div class="review-footer-left"><?php echo sizeof($complaint_reply); ?> Replies <a href="#">Go to discussion page</a></div>

                                               <div class="d-flex">
                                                Is this complaint resolved ? 
                                              <button type="button" onclick="ComplaintResolved('<?php echo $complain->product_complaint_id;?>','<?php echo $this->session->userdata('user_id'); ?>','<?php echo $complain->complaint_resolved;?>')" class="badge bg-resolved">YES</button>/ <button type="button" onclick="ComplaintResolved('<?php echo $complain->product_complaint_id;?>','<?php echo $this->session->userdata('user_id'); ?>','<?php echo $complain->complaint_resolved; ?>')" class="badge bg-unresolved">NO</button>
                                     </div>
                                    ...
                                    //echo  $this->db->last_query();
                                        ...
                                        <?php if($this->session->userdata('user_id')){ ?>
                                            <a href="javascript:void(0)" onclick="divShow(<?php echo $complain->product_complaint_id;?>);">
                         ...
                         <div class="review-row complaint_reply_<?php echo $reply->complaint_id;?>" style="display:none">
                           ...
                           <div class="review-content" >
                               <div id="complaintReplyShort_<?php echo $reply->prr_id;?>">
                                  ...
                                  if($words > 30){
                                     ?>
                                     <small class="review-read remove-bg"><a href="javascript:void(0)" id="reviewReplyShortRM_<?php echo $reply->prr_id;?>" onclick="productComplaintReplyReadMore('<?php echo $reply->prr_id;?>')">(Read More)</a></small>
                                 <?php } ?>
                             </div>
                             <div class="review-content" style="display:none" id="reviewReplyFull_<?php echo $reply->prr_id;?>"> <?php echo $reply->reply; ?> <small class="review-read remove-bg"><a href="javascript:void(0)" id="reviewReplyShortRS_<?php echo $reply->prr_id;?>" onclick="productComplaintReplyReadShort('<?php echo $reply->prr_id;?>')">(Read Short)</a> </small></div>
                         </div>
                     </div>
                 <?php } ?>
             </div>
...
//alert(action);     
   $.ajax({
    ...
    dataType: 'json',
    type: 'post',            
    data: {complaint_id: complaint_id,user_id:user_id,complaint_resolved:action},                                        
    success: function(data){             
      if(data.status=='1')
      {  
   // alert('1'); 
