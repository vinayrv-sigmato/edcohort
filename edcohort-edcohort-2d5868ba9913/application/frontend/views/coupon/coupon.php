...
<div class="tab-menu">
  <ul>
   ...
   <li class="active"><a href="<?php echo base_url(); ?>coupon?course=<?php echo @$course; ?>&brand=<?php echo $brandID;?>&product_type=<?php echo  $product_type; ?>&board=<?php echo $board;?>&class=<?php echo $class;?>&batch=<?php echo $batch; ?>&customer_rating=<?php echo  $customer_rating; ?>&date=<?php echo $date_posted; ?>&sort_by=<?php echo $sort_by; ?>">Coupons </a></li>
</ul>
</div>
</div>
<!--banner end-->
...
<div class="review-main-box d-flex">
         ...
         <div class="across">
             <div class="standard-box">
                <div class="standard-content">
                   ...
                   <div>
                    <h4><?php echo @$product_list['0']->product_name; ?></h4>
    ...
    <!--right-->
                ...
                <div class="across-row">
                    <h2 class="across-title"><span></span> Status Bar</h2>
                    <div class="card-body">
                        <?php echo message(); ?>
                            ...
                            <?php foreach($coupon_records as $coupon){ ?> 
                              <td class="text-center">
                                 <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" class="btn-check" name="confirm_bying" id="confirm_bying_<?php echo $coupon->coupon_id; ?>" onClick="couponconfirm_bying(<?php echo $coupon->coupon_id; ?>)" value="<?php echo $coupon->coupon_id; ?>">
                                    <label class="btn btn-outline-primary" for="confirm_bying_<?php echo $coupon->coupon_id; ?>"><?php echo $coupon->coupon_code ?></label>	
                                </div>
                            </td>
                        <?php } ?>
                    </tr>
                      ...
                      <?php foreach($coupon_records as $coupon){ ?> 
                          <td class="text-center">
                             <div class="btn-group" role="group" aria-label="Basic radio toggle button group">									
                                ...
                                <label class="btn btn-outline-primary" id="label_ready_buying_<?php echo $coupon->coupon_id; ?>" for="ready_buying_<?php echo $coupon->coupon_id; ?>"><?php echo $coupon->coupon_count; ?></label>
                            </div>
                        </td>
                    <?php } ?>
                </tr>
            </table>
            <input type="hidden" class="form-control" name="course" id="course" placeholder="Your Name" value="<?php echo $product_list['0']->product_id; ?>">
            <input type="hidden" class="form-control" name="user_id" id="user_id" placeholder="Your Name" value="<?php echo $this->session->userdata('user_id'); ?>">
            <input type="hidden" class="form-control" name="coupon_count" id="coupon_count" placeholder="Your Name" value="<?php echo $coupon->coupon_count; ?>">		
        </div>
        <br />
    ...
    <?php if($this->session->userdata('user_id')){ ?>
       <button type="button" onClick="conformCoupon()" class="btn btn-primary text-right btn-md mb-1">Get Your Coupon Here </button>
   <?php }else{ ?>
       <a href="javascript:void(0)" class="btn btn-primary text-right btn-md mb-1" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#login-button">Get Your Coupon Here</a>
