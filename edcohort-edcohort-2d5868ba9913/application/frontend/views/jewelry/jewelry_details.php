        ...
        <div class="container">
          <div class="row narrow-content">          
                ...
                <ul>
                  ...
                  <li class="mySlides easyzoom easyzoom--overlay easyzoom--with-thumbnails" id="slides_<?php echo $count; ?>" style="height: 400px;">                      
                    <a href="<?php echo $value; ?>">
                      <img src="<?php echo $value; ?>" alt="<?php echo $records['0']->product_name;  ?>" class="img-fluid"  />
                    </a>
                  </li>         
                  <?php $count++; } ?>
            ...
            <div class="product-cart product-details-narrow col-lg-6 col-md-6 col-sm-12 col-12 clearfix">                                                 
              <div class="product-options_header  wow fadeInUp" data-wow-delay="0.3s">
            ...
            <form action="<?php echo base_url('appointment-form') ?>" method="post" onsubmit="overlay()"  id="appointment_form1" class="form-horizontal contact-form form-design">
              <div class="form-list">
                ...
                <div class="form-schedule">
                  ...
                  <div class="col-lg-12 inner-form-schedule">
                    <div class="form-group">
                      <label class=" no-padding-right" > Preferred Date :</label>
                      <div class="">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12 clearfix border-left">
                  <div class="product-options_row">
                    ...
                    <ul class="social-list">
                      <li><a href="javascript:void(0)" class="hover-focus-border hover-focus-bg hvr-rectangle-out before-bg" id="fb_share"><span class="fab fa-facebook-f" aria-hidden="true"></span></a></li>
                      <li><a href="javascript:void(0)" class="hover-focus-border hover-focus-bg hvr-rectangle-out before-bg" id="tw_tweet"><span class="fab fa-twitter" aria-hidden="true"></span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="tabs-panel" role="tabpanel">
            <div class="tab-content wow fadeInUp" data-wow-delay="0.3s">
              <div id="description" class="row" role="tabpanel">
        ...
        <div class="container">
          <div class="starSeparatorBox clearfix">
            ...
            <div class="product-div product-bg position-relative product-overlay">
              ...
              <img src="<?php echo base_url(); ?><?php echo $row->image_show; ?>" class="img-fluid">
              </figcaption>
              </a>             
            </div>
            <div class="card-body">
