...
class Auto_excel_api_finestar extends CI_Controller {
			...
			//if($record->Message=='Success')
			{
				...
				foreach($record as $rec)
				{
					...
					$data = array(
						...
						"cash_price_discount" => $rec->DISC_PER,
					  	'depth'=>$rec->DEPTH_PER,
					  	'table_d'=>$rec->TABLE_PER,
						//'girdle_thin'=>$rec->Girdle_Min,
      		...
      		//copy($file, $newfile);
				  ...
				  $log_data=array(					  	
					  	...
					  	'file'=>'Finestar_'.date('d_m_Y_h_i_s_A'),
					  	'log_time'=>time(),
					  	'type'=>'diamond',
					  );
					//print_pre($log_data);
