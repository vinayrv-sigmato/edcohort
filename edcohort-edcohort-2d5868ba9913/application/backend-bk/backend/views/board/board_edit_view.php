                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin_board/edit_board_submit" method="post" enctype="multipart/form-data">
                                            <div class="form-group ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="board_name" name="board_name" value="<?php echo $board->board_name; ?>" placeholder="Enter Name" required onkeyup="category_slug_name(this.value)">
                                                    </div>
                                                </div>
                                            </div>
