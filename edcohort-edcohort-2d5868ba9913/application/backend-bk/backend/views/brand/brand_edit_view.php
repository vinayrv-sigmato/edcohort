                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url(); ?>admin_brand/edit_brand_submit" method="post" enctype="multipart/form-data">
                                            <div class="form-group ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="brand_name" name="brand_name" value="<?php echo $brand->brand_name; ?>" placeholder="Enter Name" required onkeyup="category_slug_name(this.value)">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label class="form-label" id="inputEmail3">Brand Slug</label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="brand_slug" id="brand_slug" placeholder="Slug" value="<?php echo $brand->brand_slug; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="form-group ">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="hidden" name="hid_image" value="<?php echo $brand->brand_image; ?>">
                                                         <?php if($brand->brand_image!=""){ ?>
                                                          <img id="upload_pic" width="100" height="100" class="img-thumbnail" src="<?php echo base_url(); ?>../uploads/brand/<?php echo $brand->brand_image; ?>" alt="no-image">
                                                        <?php } else{  ?>
                                            ...
                                            <div class="form-group ">
                                             ...
                                             <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="sort_order" id="sort_order" placeholder="Sort Order" value="<?php echo $brand->brand_sort_order; ?>">
                                                    </div>
                                                </div>
                                            </div>
