    <section class="content">
        <div class="container-fluid">
            <div class="row row-header">
                <div class="col-md-6">
                <h2>Addons <small>Add Addons</small></h2>
                </div>
                <div class="col-md-6">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="<?php echo base_url()?>admin_addons/add_submit" id="main" method="post" >
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                                        <div class="form-group">
                                            <div class="form-line ">
                                                <input type="text" class="form-control" required="required" name="addons_name" id="addons_name">
                                            </div>                                           
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <select class="form-control show-tick" name="category[]" required="" id="category" multiple data-multiple-separator=" | " data-live-search="true">
                                                    ...
                                                    <option value="<?php echo $parent_category->category_id; ?>">Category: <?php echo getMenuList($parent_category->category_id);?></option>
                                                    <?php } ?>
                                                </select>                                                 
                                            </div>                                           
                                        </div>
 ...
 <div class="hidden" style="display: none;">
    <input type="hidden" id="group_counter" value="0">
