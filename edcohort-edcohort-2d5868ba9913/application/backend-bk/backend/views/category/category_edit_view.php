                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <?php if($category->category_image!=""){ ?>
                                                          <img id="upload_pic" width="100" height="100" class="img-thumbnail" src="<?php echo base_url(); ?>../uploads/category/<?php echo $category->category_image; ?>" alt="no-image">
                                                        <?php } else{  ?>
                                            ...
                                            <div class="form-group ">
                                             ...
                                             <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="sort_order" id="sort_order" placeholder="Sort Order" value="<?php echo $category->category_sort_order; ?>">
                                                    </div>
                                                </div>
                                            </div>
