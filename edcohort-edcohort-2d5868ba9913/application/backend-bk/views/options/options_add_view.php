    <section class="content">
        <div class="container-fluid">
            <div class="row row-header">
                <div class="col-md-6">
                <h2>Options <small>Add Option</small></h2>
                </div>
                <div class="col-md-6">                 
...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="<?php echo base_url()?>admin_options/add_options_submit" id="main" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-6 col-12">
                                        <div class="form-group">
                                            <div class="form-line ">
                                                <input type="text" class="form-control" required="required" name="option_name" id="option_name">
                                            </div>                                           
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="product_tag" >
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line ">
                                                <input type="text" class="form-control" required="required" name="option_value[]"  id="attribute_name_0" onchange="getAttrValue(this.value,0)">
                                            </div>                                           
                                        </div>
                                    </div>
