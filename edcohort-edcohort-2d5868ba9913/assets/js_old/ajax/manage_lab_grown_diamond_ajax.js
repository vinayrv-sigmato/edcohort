$(document).ready(function(){
    var url=base_url+'load-more-lab-grown-diamond?page=';
    if(segment_1=="lab-grown-diamond"){
        pagination(url);
    }
    //alert(base_url); 
...
function submitForm() {
    ...
    var set_url=base_url+'lab-grown-diamond?'+value_form+'&'+$.param({ "shape": checkbox_str,"certificate": cert_str});
